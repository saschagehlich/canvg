(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("rgbcolor"), require("stackblur"), require("xmldom"));
	else if(typeof define === 'function' && define.amd)
		define(["rgbcolor", "stackblur", "xmldom"], factory);
	else if(typeof exports === 'object')
		exports["canvg"] = factory(require("rgbcolor"), require("stackblur"), require("xmldom"));
	else
		root["canvg"] = factory(root["rgbcolor"], root["stackblur"], root["xmldom"]);
...
function build (opts) {
  ...
  svg.Element.svg = function (node) {
    ...
    this.setContext = function (ctx) {
      ...
      ctx.lineJoin = 'miter'
      ctx.miterLimit = 4
      if (typeof ctx.font !== 'undefined' && typeof global.getComputedStyle !== 'undefined') {
        ctx.font = global.getComputedStyle(ctx.canvas).getPropertyValue('font')
      }
  ...
  svg.Element.a = function (node) {
    ...
    this.onclick = function () {
      global.open(this.getHrefAttribute().value)
    }
  ...
  svg.loadXmlDoc = function (ctx, dom) {
    ...
    var mapXY = function (p) {
      ...
      if (global.scrollX) p.x += global.scrollX
      if (global.scrollY) p.y += global.scrollY
      return p
    }
    ...
    var draw = function () {
      ...
      if (svg.opts['ignoreDimensions'] != true) {
        ...
        if (e.style('width').hasValue()) {
          ...
          if (typeof ctx.canvas.style !== 'undefined') {
